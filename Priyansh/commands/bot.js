...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == "Ali") || (event.body.toLowerCase() == "Brand")) {
       return api.sendMessage("Boss busy hai Mujse bat Karo 🙄", threadID);
     };
    if ((event.body.toLowerCase() == "janu") || (event.body.toLowerCase() == "jan")) {
       return api.sendMessage("Janu me serf 🥵🍷╰☆☆ᗷᖇᗩᑎᗪ☆☆╮🍷🥵 ki hu samjhy", threadID);
     };
   if ((event.body.toLowerCase() == "😂😂😂") || (event.body.toLowerCase() == "😁😁😁")) {
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     ...
     if ((event.body.toLowerCase() == "Ali") || (event.body.toLowerCase() == "Brand oye")) {
    ...
    if ((event.body.toLowerCase() == "noor") || (event.body.toLowerCase() == "Sana")) {
       return api.sendMessage("hye AYESHA ka name sunty hi kuch kuch hony lgta hai", threadID);
     };
       if ((event.body.toLowerCase() == "ali Kon ho ap") || (event.body.toLowerCase() == "Brand ap kon ho")) {
     ...
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sai Hoga ye system Har koi inbox 📥 Jana chata 😀🙄🙄 ", threadID);
      ...
      if ((event.body.toLowerCase() == "ladki ho")) {return api.sendMessage("Nahi ye both Hai tharki insan 😂😀🙄 ", threadID);
              ...
              if ((event.body.toLowerCase() == "wow")) {return api.sendMessage("Thank you Apko bhi bot chahiya tOo 🥵🍷╰☆☆ᗷᖇᗩᑎᗪ☆☆╮🍷🥵 se rabta karo👍👍💕" , threadID);
     };
      ...
      if ((event.body.toLowerCase() == "Sana")) {return api.sendMessage("bahot pyari Ladkı Hai Sana MashaAllah  💕💕❤️🤭 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "👌")) {return api.sendMessage("𝑻𝒖𝒔𝒊 𝒂𝒘𝒔𝒐𝒎𝒆 𝒉𝒐 𝒈👌👌 ", threadID);
    ...
    if ((event.body.toLowerCase() == "kiss kar")) {return api.sendMessage(" ️sab dekh rahe hai wrna bhot kiss deti🙈 ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🤤")) {return api.sendMessage("Mho se supari nikal rey baba 🤣🤣", threadID);
     ...
     if ((event.body.toLowerCase() == "logos") || (event.body.toLowerCase() == "logo")) {
       return api.sendMessage("Logos ! 🥀 GALAXY, CAKE, CRACK, GLITCH, CLOUD, DRAGON, FROZEN, BUSINESS, ANIMATE, LOGODIAMOND, LOGOCAPTAIN, LOGOFISH, LOGOCOLORBLUR, LOGOBLOODTEXT, LOGOWOOD, LOGOCUP          🥀for example -> +crack Ali Brand", threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
       return api.sendMessage("good morning god bless you Dear💓", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me Brand ki setting hu😘", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻🥵🍷╰☆☆ᗷᖇᗩᑎᗪ☆☆╮🍷🥵:-☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝Ali Brand ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Brand. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/⤾➝BRAND↬ X⤹❤️‍🩹🙂⇣☞ ☜ ༺༒ ༒", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "is bot ka malik kon hai")) {
       return api.sendMessage("⤾➝BRAND↬ X⤹❤️‍🩹🙂⇣ 𝐔𝐫𝐟 Shaani   ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };

    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is ⤾➝BRAND↬ X⤹❤️‍🩹🙂⇣. He Gives his name mr Brand everywhare", threadID);
     };

     if ((event.body.toLowerCase() == "acha") || (event.body.toLowerCase() == "acha ji")) {
       return api.sendMessage("🤍Acha toh me bachpan se hi hu😘", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "bye")) {;
     ...
     if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "chup ho ja") || (event.body.toLowerCase() == "chup kar")) {
       return api.sendMessage("Nhi rahungi 😼 Mujhe Bolna H. Tumhe Koi Haq nhi Mujhe Chup Karane ka. Mera Zuban. M Bolungi Brand ko baton kya🙄🙄", threadID);
     };
    if ((event.body.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
     ...
     if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
       return api.sendMessage("sorry malik maaf kr do ab nhi krugi ⤾➝BRAND↬ X⤹❤️‍🩹🙂⇣ please maaf karo na🥺🙏", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "bot kiss me") || (event.body.toLowerCase() == "kiss me")) {
       return api.sendMessage("️Kis khushi me, Me sirf Apne Boss Brand ko kiss karna chahti hu", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "i yad You") || (event.body.toLowerCase() == "patogi")) {     return api.sendMessage("️️️nikal tharki group se remove kar dougi", threadID);
     };

    if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "love you")) {     return api.sendMessage("️️️ITNE MUJHE I LOVE YOU BOL RHI HO MERE BOSS ALI BRAND URF 🥵🍷╰☆☆ᗷᖇᗩᑎᗪ☆☆╮🍷🥵 KO BOLO BAHUT HI ACHA BNDA HAI MERA BOSS ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🙄")) {return api.sendMessage(" Ali Boss busy hai mujse bat karo🙄🙄 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE ⤾➝BRAND↬ X⤹❤️‍🩹🙂⇣ KO DEKHO PYARA NA LAGY PAISE WAPIS 😝😂 ", threadID);
     };

  if ((event.body.toLowerCase() == "😎😎")) {return api.sendMessage("CHALA JAA BOSD..K....🤣🤣🤝🏻", threadID);
     };

  if ((event.body.toLowerCase() == "😋😋")) {return api.sendMessage("😒GHR WALO NE AJ ROTI NHI DALI 🤣🤝🏻", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🥰🥰🥰")) {return api.sendMessage("TU TOO GYAA BETYYY 🤣", threadID);
    ...
    if ((event.body.toLowerCase() == "🥵")) {return api.sendMessage("KUTTY PICHY PAR GAY THY KIYA YAAR 😒", threadID);
     };

  if ((event.body.toLowerCase() == "😍")) {return api.sendMessage("IS NAZAR SE MERE OWNER BRAND KO DEKHO MAZA NA AY TO PAISE WAPIS 😝😂 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🧐")) {return api.sendMessage("Kuch to Garbadh hai daya😂😂🤞🤞", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤣")) {return api.sendMessage("Haasne ki bhi tameez hoti hai thwrki🤐😏😹😜", threadID);
     ...
     if ((event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "assalam u walaikum") || (event.body.toLowerCase() == "salaam")) {
      return api.sendMessage("️ walaikum assalam 🙃♥", threadID);
     };

     if ((event.body.toLowerCase() == "Ib aa") || (event.body.toLowerCase() == "Inbox aa")) {
       return api.sendMessage("️Jo bolna hak yhi bol 😒😒 Bramd me bola ib nahi jana", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😘")) {return api.sendMessage("Pehle  Brush Karke aa Fir Dungi 🫣🫂😘 ", threadID);
    };
  ...
  if ((event.body.toLowerCase() == "🤐")) {
    ...
    if ((event.body.toLowerCase() == "😉") || (event.body.toLowerCase() == "😉")) {
       return api.sendMessage("️Aankh kyu maar rahe ho, Ane Do Brand ko🥺", threadID);
     };
